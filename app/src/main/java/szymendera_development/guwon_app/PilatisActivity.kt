...
import kotlinx.android.synthetic.main.activity_pilatis.*
import kotlinx.android.synthetic.main.app_bar_pilatis.*
import szymendera_development.guwon_app.Utils.*

class PilatisActivity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_pilatis)
        ...
        navheaderlogo.setOnClickListener(object : View.OnClickListener {
            override fun onClick(v: View) {
                val intent = Intent(this@PilatisActivity, MainActivity::class.java)
                this@PilatisActivity.startActivity(intent)
            }
        })
    }
