...
import kotlinx.android.synthetic.main.app_bar_yoga.*
import szymendera_development.guwon_app.Utils.*

class YogaActivity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        navheaderlogo.setOnClickListener(object : View.OnClickListener {
            override fun onClick(v: View) {
                val intent = Intent(this@YogaActivity, MainActivity::class.java)
                this@YogaActivity.startActivity(intent)
            }
        })
    }
