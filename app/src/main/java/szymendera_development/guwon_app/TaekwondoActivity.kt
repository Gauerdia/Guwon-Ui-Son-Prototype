...
import kotlinx.android.synthetic.main.activity_taekwondo.*
import kotlinx.android.synthetic.main.app_bar_taekwondo.*
import szymendera_development.guwon_app.Utils.*

class TaekwondoActivity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        navheaderlogo.setOnClickListener(object : View.OnClickListener {
            override fun onClick(v: View) {
                val intent = Intent(this@TaekwondoActivity, MainActivity::class.java)
                this@TaekwondoActivity.startActivity(intent)
            }
        })
    }
