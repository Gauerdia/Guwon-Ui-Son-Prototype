...
import kotlinx.android.synthetic.main.activity_nordic_walking.*
import kotlinx.android.synthetic.main.app_bar_nordic_walking.*
import szymendera_development.guwon_app.Utils.*

class NordicWalkingActivity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_nordic_walking)
        ...
        navheaderlogo.setOnClickListener(object : View.OnClickListener {
            override fun onClick(v: View) {
                val intent = Intent(this@NordicWalkingActivity, MainActivity::class.java)
                this@NordicWalkingActivity.startActivity(intent)
            }
        })
    }
