...
import kotlinx.android.synthetic.main.activity_kickboxen.*
import kotlinx.android.synthetic.main.app_bar_kickboxen.*
import szymendera_development.guwon_app.Utils.*

class KickboxenActivity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_kickboxen)
        ...
        navheaderlogo.setOnClickListener(object : View.OnClickListener {
            override fun onClick(v: View) {
                val intent = Intent(this@KickboxenActivity, MainActivity::class.java)
                this@KickboxenActivity.startActivity(intent)
            }
        })
    }
