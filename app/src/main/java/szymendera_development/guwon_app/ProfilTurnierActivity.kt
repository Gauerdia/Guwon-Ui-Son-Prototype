...
import kotlinx.android.synthetic.main.activity_profil_turnier.*
import kotlinx.android.synthetic.main.app_bar_profil_turnier.*
import szymendera_development.guwon_app.Utils.*

class ProfilTurnierActivity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {

    var sp: SharedPreferences? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_profil_turnier)
        ...
        navheaderlogo.setOnClickListener(object : View.OnClickListener {
            override fun onClick(v: View) {
                val intent = Intent(this@ProfilTurnierActivity, MainActivity::class.java)
                this@ProfilTurnierActivity.startActivity(intent)
            }
        })
    }
    ...
    override fun onCreateOptionsMenu(menu: Menu): Boolean {
        ...
        menuInflater.inflate(R.menu.profil_turnier, menu)
        return true
    }
